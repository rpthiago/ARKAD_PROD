...
def check_entry_conditions(ms):
    odd = ms.get("Odd_0x2_Lay") or ms.get("Odd_0x2_FT") or 0.0
...
def predict_and_evaluate_live(live_games_payload, df_historical):
    ...
    for g in live_games_payload:
        ...
        odd_0x2 = pd.to_numeric(g.get("Odd_0x2_Lay") or g.get("Odd_0x2_FT") or g.get("Odd_0x2_Back") or g.get("Odd_0x2") or np.nan, errors="coerce")
