"""lay_0x2_rf_v2_strategy.py — Lay 0x2 v2 | ROI OOS +27.2% | 66633 picks | ROI>0 4/4"""
...
BLACKLIST_LIGAS = [
    "ENGLAND 5", "BELGIUM 1", "WALES 1", "ITALY 2",
    "ECUADOR 1", "VENEZUELA 1", "FRANCE CUP", "JAPAN 2",
    "NETHERLANDS 1"
]
...
def check_entry_conditions(ms):
    ...
    # Novo Filtro: Evitar zebras extremas em casa (Odd_H_FT <= 3.00)
    odd_h = ms.get("Odd_H_FT") or ms.get("Odd_H_Back") or 0.0
    if not pd.isna(odd_h) and odd_h > 3.00:
