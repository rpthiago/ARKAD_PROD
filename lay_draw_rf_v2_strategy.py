...
# 0.23 = mediana; passou FDR (+11.9%, IC[+7.1%,+17.4%], p<0.0001), robusto ano-a-ano/H1-H2/
# hold-out limpo/threshold. Ver PREREGISTRO_lay_draw_forward.md. NAO re-otimizar (0.20-0.26 tudo serve).
