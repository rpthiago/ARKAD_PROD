...
def check_entry_conditions(ms):
    odd = ms.get("Odd_CS_1x0_Lay") or ms.get("Odd_1x0_Lay") or ms.get("Odd_CS_1x0") or ms.get("Odd_1x0_FT") or 0.0
...
def predict_and_evaluate_live(live_games_payload, df_historical):
    ...
    for g in live_games_payload:
        ...
        odd_1x0 = pd.to_numeric(g.get("Odd_CS_1x0_Lay") or g.get("Odd_1x0_Lay") or g.get("Odd_CS_1x0") or g.get("Odd_1x0_FT") or g.get("Odd_1x0_FT") or g.get("Odd_1x0_Back") or g.get("Odd_1x0") or np.nan, errors="coerce")
        ...
        ms = {"Home": home, "Away": away, "League": league, "Date": date_v, "Time": g.get("Time", ""),
              "Odd_1x0_FT": odd_1x0, "Odd_1x0_Lay": odd_1x0, "Odd_CS_1x0_Lay": odd_1x0, "Odd_H_FT": odd_h, "Odd_A_FT": odd_a}
