@echo off
REM 06:00 — (1) relatorio dos 5 metodos em validacao forward -> Telegram (ledger proprio, nao toca planilhas);
...
%PY% relatorio_forward_5metodos.py --ontem >> metodos_aprovados\forward_5metodos.log 2>&1
