...
def check_entry_conditions(ms):
    odd = ms.get("Odd_2x0_Lay") or ms.get("Odd_2x0_FT") or 0.0
...
def predict_and_evaluate_live(live_games_payload, df_historical):
    ...
    for g in live_games_payload:
        ...
        odd_2x0 = pd.to_numeric(g.get("Odd_2x0_Lay") or g.get("Odd_2x0_FT") or g.get("Odd_2x0_Back") or g.get("Odd_2x0") or np.nan, errors="coerce")
