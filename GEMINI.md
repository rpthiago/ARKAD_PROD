...
| **Miragem do Lay 0x1 com Corte de Odd Estrita vs Executável KO−10** (Achar que corte Lay 10–16 / Fav Mandante [1.55, 2.15] gera +1,09% de alpha) | **Na odd executável real de KO−10 o método PERDE −4,46% a −6,98% (N=161, 17 reds).** Na base FRESH3 o +1,09% foi ruído de condicionamento com IC95 cruzando zero ([−0,8%, +2,9%], P=0,14); nos vizinhos de odd (8–20) o ROI inverte para −0,16% e 2024-25 é negativo. Blacklist de ligas foi post-hoc (sem blacklist rendeu mais: +6,31u vs +6,08u). Circuit breakers pioram o drawdown (stop 1 red eleva maxDD de 4,06u para 4,92u). Auditado por Claude em 21/09/2026. **ARQUIVADO DEFINITIVAMENTE (Lei 8 / Morte Confirmada).** |
...
- **MORTOS / miragem (na odd de lay real e scan exaustivo):** Lay 0x0 (paper de agosto: **−R$1.979**), Lay 1x0
  ...
  Back BTTS Yes / BTTS Não (overround de 8,3% consome edge; Back Não = −10,1% em 2.580 jogos, 0/8 meses; ruído de escala), Over 2.5, Saldo Menor, EH+3 múltiplas,
   ...
   Lay 0x1 Sniper / Cortes Estritos de Odd (Backtest FRESH3 2026 +1,09% P=0,14 cruza zero; na odd executável KO−10 do coletor N=161 dá **−4,46%** e com liq≥200 dá **−6,98%** [teto IC95 < 0]; vizinho 8–20 inverte para −0,16%; blacklist de ligas reduziu o lucro; **ARQUIVADO DEFINITIVAMENTE / Morte Confirmada**).
