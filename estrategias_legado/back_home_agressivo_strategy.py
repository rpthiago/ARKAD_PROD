...
MODEL_PATH = "modelo_Back_Home_Agressivo.pkl"
SCALER_PATH = "scaler_Back_Home_Agressivo.pkl"
FEATURES_PATH = "features_Back_Home_Agressivo.pkl"
LIGAS_PATH = "ligas_Back_Home_Agressivo.txt"
...
def check_entry_conditions(match_state):
    odd_home = match_state.get('Odd_H_FT') or 0.0
    if pd.isna(odd_home) or odd_home < 1.55 or odd_home > 1.70:
...
def log_paper_trade(match_state):
    log_file = "paper_trading_log_back_home.csv"
    ...
    row = {
        ...
        'xG_Diff_5': match_state.get('xG_Diff_5', 0.0),
        'H_Win_Streak_5': match_state.get('H_Win_Streak_5', 0.0),
        'A_Fragility_Sum': match_state.get('A_Fragility_Sum', 0.0),
...
def predict_and_evaluate_live(live_games_payload, df_historical):
    ...
    df_h = df_hist[['Date', 'Home', 'Goals_H_FT', 'Goals_A_FT',
                     'Total_Shots_H_FT', 'Shots_On_Target_H_FT', 'xG_H_FT', 'xG_A_FT']].copy()
    ...
    df_a = df_hist[['Date', 'Away', 'Goals_A_FT', 'Goals_H_FT',
                     'Total_Shots_A_FT', 'Shots_On_Target_A_FT', 'xG_A_FT', 'xG_H_FT']].copy()
    ...
    df_teams['Home_Win_Flag'] = ((df_teams['Is_Home'] == 1) & (df_teams['Goals_Scored'] > df_teams['Goals_Conceded'])).astype(float)
    df_teams['H_Win_Streak_5'] = (
        df_teams.groupby('Team')['Home_Win_Flag']
    ...
    for g in live_games_payload:
        ...
        norm_g['H_Win_Streak_5'] = sh['H_Win_Streak_5']
        ...
        norm_g['xG_Diff_5'] = norm_g['H_xG_Scored_5'] - norm_g['A_xG_Conceded_5']
        norm_g['Goals_Diff_5'] = norm_g['H_Goals_Scored_5'] - norm_g['A_Goals_Conceded_5']
        norm_g['A_Fragility_Sum'] = norm_g['A_Goals_Conceded_5'] + norm_g['A_xG_Conceded_5']
        norm_g['H_Dominance_Score'] = norm_g['H_Win_Streak_5'] * norm_g['xG_Diff_5']
        norm_g['SoT_Diff_5'] = norm_g['H_SoT_5'] - norm_g['A_SoT_5']
        ...
        norm_g['Ratio_DA'] = norm_g['Odd_D_FT'] / (norm_g['Odd_A_FT'] + 1e-10)
