"""lay_home_fs_strategy.py — Lay home (FOOTYSTATS) | ROI OOS +5.3% | 37529 picks | ROI>0 4/4"""
import os, pandas as pd, numpy as np, joblib
from datetime import datetime
from pathlib import Path

ROOT = Path(__file__).resolve().parent
MODEL_PATH    = str(ROOT / "modelo_lay_home_fs.pkl")
SCALER_PATH   = str(ROOT / "scaler_lay_home_fs.pkl")
FEATURES_PATH = str(ROOT / "features_lay_home_fs.pkl")
COMMISSION = 0.05
EV_MIN     = 0.03
...
def log_paper_trade(ms):
    ...
    f = "paper_trading_log_lay_home_fs.csv"
