"""lay_btts_fs_strategy.py — Lay btts (FOOTYSTATS) | ROI OOS +5.6% | 66792 picks | ROI>0 3/4"""
import os, pandas as pd, numpy as np, joblib
from datetime import datetime
from pathlib import Path

ROOT = Path(__file__).resolve().parent
MODEL_PATH    = str(ROOT / "modelo_lay_btts_fs.pkl")
SCALER_PATH   = str(ROOT / "scaler_lay_btts_fs.pkl")
FEATURES_PATH = str(ROOT / "features_lay_btts_fs.pkl")
COMMISSION = 0.05
EV_MIN     = 0.02
ODD_MIN, ODD_MAX = 1.5, 2.6
...
def log_paper_trade(ms):
    ...
    f = "paper_trading_log_lay_btts_fs.csv"
