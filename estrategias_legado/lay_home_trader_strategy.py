...
def normalize_live_data(live_payload):
    ...
    # FIX: Odd_H_Lay obrigatoria — sem fallback para Odd_H_FT / Odd_H_Back.
    # Usar Back como proxy para Lay subestima a liability real (liability = stake * (Lay - 1)).
...
def check_entry_conditions(match_state):
    # FIX: Removido fallback para Odd_H_FT — somente Odd_H_Lay e valida para calculo de liability
...
def predict_and_evaluate_live(live_games_payload, df_historical):
    ...
    for g in live_games_payload:
        ...
        # FIX: Descartar entrada se Odd_H_Lay for nula — sem fallback para Back/FT.
        # Uma entrada sem Odd_H_Lay valida tornaria o calculo de liability indefinido.
